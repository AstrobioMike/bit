...
### This is modified from the "download-db.sh" script that came with the conda install of gtdbtk v2.4.0.
    # The primary download site, link commented out below, had been consistently taking over a week to download for me and others.
    # So I added this to the workflow for now to pull from the mirror site (new DB_URL below).
...
DB_URL="https://data.ace.uq.edu.au/public/gtdb/data/releases/release220/220.0/auxillary_files/gtdbtk_package/full_package/gtdbtk_r220_data.tar.gz"
